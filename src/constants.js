...
export const C = {
  ...
  bgGradient: "linear-gradient(135deg, rgba(30,10,60,0.92) 0%, rgba(13,27,75,0.92) 38%, rgba(12,66,112,0.92) 65%, rgba(11,122,107,0.92) 100%), url('/ashiyagawa.jpg') bottom center/100% auto no-repeat fixed",
  // ガラスカード
